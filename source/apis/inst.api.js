...
export class InstApi{
    ...
    fuwuinfo(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'inst/fuwuinfo',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    yinsiinfo(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'inst/yinsiinfo',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
